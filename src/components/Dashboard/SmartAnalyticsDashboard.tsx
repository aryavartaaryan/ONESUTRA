...
function MiniHabitCard({ habit, isCompleted, streak, onComplete }: {
  ...
  return (
    <motion.div layout initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}
      ...
      style={{
        display: 'flex', alignItems: 'center', gap: 0, borderRadius: 18, marginBottom: '0.45rem', position: 'relative', overflow: 'hidden',
      ...
      {/* Icon badge */}
      <div style={{
        margin: '0.65rem 0.6rem 0.65rem 0.72rem', width: 42, height: 42, borderRadius: 14, flexShrink: 0,
      ...
      <div style={{ flex: 1, minWidth: 0, paddingRight: '0.3rem' }}>
        <p style={{
          margin: 0, fontSize: '0.92rem', fontWeight: 800, fontFamily: "'Outfit', sans-serif",
