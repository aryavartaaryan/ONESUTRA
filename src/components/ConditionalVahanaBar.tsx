...
export default function ConditionalVahanaBar() {
    ...
    const hideNav = pathname.startsWith('/dhyan-kshetra') || pathname.startsWith('/onesutra') || pathname.startsWith('/acharya-sanctum') || pathname.startsWith('/resonance') || pathname.startsWith('/pranaverse');
