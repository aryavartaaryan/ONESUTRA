...
// ─── Google "G" path SVG (no brand name, just the iconic shape) ──────────────
        ...
        <div style={{ position: 'relative', width: '100%', display: 'flex', justifyContent: 'center' }}>
            ...
            <motion.button
                ...
                style={{
                    ...
                    borderRadius: '80px', // pure pill shape / water droplet
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
            ...
            <div style={{ width: '100%', marginBottom: compact ? '0.8rem' : '1.2rem', marginTop: compact ? 0 : '1rem' }}>
                <GlassButton
                    delay={1.0}
                    variant="google"
                    icon={<GoogleG size={22} />}
                    label="Continue with Google"
                    sublabel="Secure · Instant · Remembered across devices"
            ...
            <motion.div
                ...
                style={{ display: 'flex', alignItems: 'center', gap: 12, width: '100%', marginBottom: compact ? '0.8rem' : '1.2rem' }}
            >
                <div style={{ flex: 1, height: 1, background: 'linear-gradient(to right, transparent, rgba(255,255,255,0.06))' }} />
                <span style={{ fontSize: '0.42rem', color: 'rgba(255,255,255,0.12)', letterSpacing: '0.22em', fontFamily: 'monospace' }}>OR</span>
                <div style={{ flex: 1, height: 1, background: 'linear-gradient(to left, transparent, rgba(255,255,255,0.06))' }} />
            </motion.div>

            {/* ── BUTTON 2: Continue as Traveller ── */}
            <div style={{ width: '100%', marginBottom: 'clamp(0.8rem,2vh,1.2rem)' }}>
                <GlassButton
                    delay={1.3}
                    variant="traveller"
                    icon={<TravellerGlyph size={22} />}
                    label="Continue as Traveller"
                    sublabel="Explore freely · No account needed"
                    onClick={onGuest}
                    disabled={false}
                />
            </div>
